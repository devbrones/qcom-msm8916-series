...
LOCAL_POST_INSTALL_CMD += \
    ...
    ln -sf /vendor/odm/modem/image/wcnss.b12 $(TARGET_OUT_VENDOR)/firmware/wcnss.b12; \
    ln -sf /vendor/odm/modem/image/wcnss.mdt $(TARGET_OUT_VENDOR)/firmware/wcnss.mdt; \
    ln -sf /vendor/odm/persist/WCNSS_tct_wlan_nv.bin $(TARGET_OUT_VENDOR)/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin; # found in data/misc/wifi/

# Symlink non-splitted venus fimware for backward compatibility
LOCAL_POST_INSTALL_CMD += \
    mkdir -p $(TARGET_OUT_VENDOR)/firmware/qcom/venus-1.8/ ; \
    ln -sf venus.mbn $(TARGET_OUT_VENDOR)/firmware/qcom/venus-1.8/venus.mdt; # in system/etc/firmware/venus.mbn
